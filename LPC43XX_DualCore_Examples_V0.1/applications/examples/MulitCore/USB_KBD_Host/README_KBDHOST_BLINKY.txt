USB Key Board Host example:
===========================
The USB_KBD_HOST example demonstrates the USB Key board host functionality using the NXPUSBLIB library. The USB Key board functionality can be executed on Cortex-M4 or Cortex-M0 cores.

USB KBD host Configurations:
============================
The USB KBD host example builds the application code with required libraries to build the executable.
The USB KBD host example can be built by using the Example_KBDHost_Blinky.uvproj Keil project. This has the following configurations:
1. USB_noOS_M0 - This will build the demo with USB KBD & Blinky example in stand alone configuration for M0 core 
2. Blinky_noOS_M0 - This will build the demo with Blinky example in stand alone configuration for M0 core
3. USB_noOS_M4 - This will build the demo with USB KBD & Blinky example in stand alone configuration for M4 core 
4. Blinky_noOS_M4 - This will build the demo with Blinky example in stand alone configuration for M4 core 
5. USB_FreeRTOS_M0 - This will build the demo with USB KBD & Blinky example in FreeRTOS configuration for M0 core 
6. Blinky_FreeRTOS_M0 - This will build the demo with Blinky example in FreeRTOS configuration for M0 core
7. USB_FreeRTOS_M4 - This will build the demo with USB KBD & Blinky example in FreeRTOS configuration for M4 core 
...
The user can build the demo to have USB KBD host running on either M4 core or M0 core.
...
2. Right click on "Example_KBDHost_Blinky" project & set as default project to build

The user can choose whether to have USB KBD Host running on M4 or M0 core.

M4 Running USB KBD host & M0 core running Blinky in stand-alone configuration:
==============================================================================
3. Build the libraries required for the M4 & M0 applications by using the "Project->Batch Build" option in Keil GUI
   ...
   USB_noOS_M4 - CDL_LPC43xx_M4.lib, BSP_LPC43XX_M4.lib, IPC_noOS_m4.lib, nxpUSBlib_LPC43xx_Host_M4.lib 
...
5. Choose M4 USB project configuration to be build from drop down menu, from "project" menu in Keil GUI, click on "Build" option to build
   - USB_noOS_M4 - It will output usbKBDHost_noOS_M4.axf executable 

M0 Running USB KBD host & M4 core running Blinky in stand-alone configuration:
===================================================================================
3. Build the libraries required for the M4 & M0 applications by using the "Project->Batch Build" option in Keil GUI
   USB_noOS_M0 - CDL_LPC43xx_M0.lib, BSP_LPC43XX_M0.lib, IPC_noOS_m0.lib, nxpUSBlib_LPC43xx_Host_M0.lib 
...
M4 Running USB KBD Host & M0 core running Blinky in FreeRTOS configuration:
===========================================================================
3. Build the libraries required for the M4 & M0 applications by using the "Project->Batch Build" option in Keil GUI
   Blinky_FreeRTOS_M0 - CDL_LPC43xx_M0.lib, BSP_LPC43XX_M0.lib, IPC_noOS_m0.lib, FreeRTOS_LPC43XX_M0.lib
   USB_FreeRTOS_M4 - CDL_LPC43xx_M4.lib, BSP_LPC43XX_M4.lib, IPC_noOS_m4.lib, nxpUSBlib_LPC43xx_Host_M4.lib, FreeRTOS_LPC43XX_M4.lib  
4. Choose M0 Blinky project configuration to be build from drop down menu, from "project" menu in Keil GUI, click on "Build" option to build
   - Blinky_FreeRTOS_M0 - It will output m0_image.c file which is included with M4 image 
5. Choose M4 USB project configuration to be build from drop down menu, from "project" menu in Keil GUI, click on "Build" option to build
   - USB_FreeRTOS_M4 - It will output usbKBDHost_FreeRTOS_M4.axf executable  

M0 Running USB KBD Host & M4 core running Blinky in FreeRTOS configuration:
============================================================================
3. Build the libraries required for the M4 & M0 applications by using the "Project->Batch Build" option in Keil GUI
   USB_FreeRTOS_M0 - CDL_LPC43xx_M0.lib, BSP_LPC43XX_M0.lib, IPC_noOS_m0.lib, nxpUSBlib_LPC43xx_Host_M0.lib, FreeRTOS_LPC43XX_M0.lib  
...
Once the demo code is run on the board.
 ...
 - Connect the USB Key board to USB0 host connector on MCB4300 board, the KBD should should be enumerated.
 - The keys typed using the USB key board will be displayed on UART COM terminal  
